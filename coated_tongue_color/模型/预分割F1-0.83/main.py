...
class_sample_counts = [900, 150, 40, 8, 6]
...
def data_load():
    ...
    #                       task_label="苔色", category=['白', '淡黄', '黄', '焦黄', '灰黑'],
    #                       label_filename='.\\datas\\data2\\st2_total_detail(20220506)_sm_noval_last.json')
    train_db = ReaderClassfiedCoatData(root=r'D:\MyCodes\pythonProject\coated_tongue_color\datas\data21\category',
                                       mode='train')
    val_db = ReaderClassfiedCoatData(root=r'D:\MyCodes\pythonProject\coated_tongue_color\datas\data21\category',
                                     mode='test')
    test_db = ReaderClassfiedCoatData(root=r'D:\MyCodes\pythonProject\coated_tongue_color\datas\data21\category',
                                      mode='test')
    # 重采样
