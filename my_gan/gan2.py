...
dataroot = os.path.join('jiaohei', 'train')
...
for epoch in range(num_epochs):
    ...
    viz.line([[errG.item(), errD.item()]], [epoch], win='train', update='append')
    gen_img_plot(netG, epoch, noise)

    # 保存模型
    torch.save(netG.state_dict(), 'netG.mdl')
    torch.save(netD.state_dict(), 'netD.mdl')
